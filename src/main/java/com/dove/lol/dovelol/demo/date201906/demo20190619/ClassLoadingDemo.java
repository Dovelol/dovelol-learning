package com.dove.lol.dovelol.demo.date201906.demo20190619;
...
public class ClassLoadingDemo {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        String className = "com.dove.lol.dovelol.model.User";
    ...
    static class MyClassLoader extends ClassLoader {
        ...
        private byte[] loadBytes(File classFile) {
            byte[] bytes = null;
            try {
                bytes = FileCopyUtils.copyToByteArray(classFile);
            } catch (IOException e) {
